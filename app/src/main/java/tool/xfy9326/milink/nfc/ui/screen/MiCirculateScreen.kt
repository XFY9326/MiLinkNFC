...
import tool.xfy9326.milink.nfc.ui.vm.MiCirculateViewModel


const val MiCirculateRoute = "mi_circulate"
...
@Composable
fun MiCirculateScreen(
    viewModel: MiCirculateViewModel = viewModel(),
    ...
    Scaffold(
        ...
        topBar = {
            LargeTopAppBar(
                title = { Text(text = stringResource(id = R.string.mi_circulate_nfc)) },
                navigationIcon = {
